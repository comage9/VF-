...
urlpatterns = [
    ...
    path('production-log/bulk-delete', views.production_log_bulk_delete, name='production-log-bulk-delete'),
    ...
    path('production/move-incomplete', views.production_move_incomplete, name='production-move-incomplete'),
]
