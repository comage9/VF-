...
| `/product-display` | **제품 배치도** | 총괄(A~E동 미니) + 동별 상세 · **A동 120품목 상위권+분류밴드 재배치(8/17)** · B동 6분류 3개/칸(137품목) · C동 와이드2·슬림형3개/칸(212품목) · D동 탑백·초대형·해피(75품목) · 조건 기반 재배치 도구: `python backend/scripts/vf_replan.py --help` |
