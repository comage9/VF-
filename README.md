...
| `/product-display` | **제품 배치도** | 총괄(A~E동 미니) + 동별 상세 · A동 세로 슬롯 라인(1~19)·L7 바퀴슬림 2품목/칸 · B동/C동 블록 · 툴팁(분류+제품명+재고+출고 4일치 가중) · 미배치=A/B동 배치 통합 제외 · 위치 검색(제품명/로케이션/제품번호/바코드→동·슬롯 이동) · localStorage |
