...
| `/product-display` | **제품 배치도** | 총괄(A~E동 미니) + 동별 상세 · A동 세로 슬롯 라인(1~19)·L7 바퀴슬림 2품목/칸 · **B동 6분류 재진열(137품목)** · **C동 와이드73+에센셜28+모던플러스52+맥스38+슬림형21(212품목)** · **D동 탑백40+초대형21+해피11(72품목, 2·2·3개/칸)** · 툴팁(분류+제품명+재고+출고) · 헤더 배치=실제 합산·미배치 **빨간색** 표시 · 위치 검색 · 깜박임(검색 이동) · localStorage |
