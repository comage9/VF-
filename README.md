...
| `/product-display` | **제품 배치도** | 총괄(A~E동 미니) + 동별 상세 · A동 세로 슬롯 라인(1~19)·L7 바퀴슬림 2품목/칸 · **B동 6분류 재진열(137품목)** · **C동 와이드73+에센셜28+모던플러스52+맥스38+슬림형21(212품목)** · **D동 41칸(엑셀 도면, 상단8+중앙1·2 16+우측1·2 12+하단5)** · 툴팁(분류+제품명+재고+출고) · 헤더 배치=실제 합산·미배치 **빨간색** · 위치 검색+깜박임 |
