...
| `/product-display` | **제품 배치도** | 총괄(A~E동 미니) + 동별 상세 · A동 세로 슬롯 라인(1~19)·L7 바퀴슬림 2품목/칸 + **L7 6슬롯 슬림서랍장 추가(210/214/203/225/246/201, 총 130품목)** · **B동 6분류 재진열(137품목)** · **C동 와이드73+에센셜28+모던플러스52+맥스38+슬림형21(212품목)** · **D동 탑백40+초대형21+해피11+슬라이딩스텝3(75품목, 2·...[truncated]
